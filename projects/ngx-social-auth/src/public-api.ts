/*
 * Public API Surface of ngx-social-auth
 */

export * from './lib/social-auth.module';
export * from './lib/social-auth.service';
export * from './lib/social-auth-module-config';
export * from './lib/provider/social-auth-provider';
export * from './lib/provider/social-auth-config-map';
export * from './lib/social-auth-provider-type.enum';
export * from './lib/auth-response/social-auth-response';
export * from './lib/auth-response/social-auth-response-map';
